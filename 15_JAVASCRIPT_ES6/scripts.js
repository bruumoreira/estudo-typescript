...
// 4 - Map
const products = [
    {name: 'Camisa', price: 12.99, category: 'Roupas'},
    {name: 'Cafeteira Elétrica', price: 189.99, category: 'Eletro'},
    {name: 'Microondas', price: 350.00, category: 'Eletro'},
