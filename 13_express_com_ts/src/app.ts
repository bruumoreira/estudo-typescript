...
// 7 - parametros de rotas (router parameters)
...
// 9 - router handler (retira a função anônima de uma rota e externaliza em uma função)
...
// 10 - middleware (recurso para executar função entre a execução de uma rota, para validações)
...
// 12 - Request e response generics (argumentos que vem pelo request e vão pela response)
app.get(
